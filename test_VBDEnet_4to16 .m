...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
patch_num=4;      % patch numbers for total test images
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
result_data_path=['./test1021/'];
if ~exist(result_data_path,'dir')
    mkdir(result_data_path);
end
model_def_file = './test_proposed.prototxt';
model_file =  ['./train_iter_160000.caffemodel'];
...
for channel = 1:3
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    PRED_PATH_new = ['./test_data/pred_cut' num2str(channel) '_256/pred_data_cut' num2str(imgIdx)];
